...
namespace HaloFrame
{
 ...
 deleteFailureFile};
                ...
                request.redirectLimit = DownloadDataProxy.RedirectLimit;
                {
                    ...
                    DownloadStartEventArgs.Clear(startEventArgs);
                }
...
#endif
                {
                    if (request.isDone)
                    {
                        ...
                        OnFileDownloading(downloadInfo);
                        DownloadSuccessEventArgs.Clear(successEventArgs);
                ...
                else
                {
                    ...
                    DownloadFailureEventArgs.Clear(failureEventArgs);
        ...
        void OnFileDownloading(DownloadInfo info)
        {
            ...
            DonwloadUpdateEventArgs.Clear(eventArgs);
        }
        ...
        void OnPendingTasksCompleted()
        {
            ...
            DownloadTasksCompletedEventArgs.Clear(eventArgs);
            //清理下载配置缓存；
            failedInfos.Clear();
