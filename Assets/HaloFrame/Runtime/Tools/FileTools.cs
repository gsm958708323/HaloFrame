...
namespace HaloFrame
{
    public class FileTools
    {
        ...
        public static bool SafeWriteAllText(string outFile, string text)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeWriteAllText failed! path = {0} with err = {1}", outFile,
                    ex.Message));
                return false;
            }
        }
        ...
        public static byte[] SafeReadAllBytes(string inFile)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeReadAllBytes failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static string[] SafeReadAllLines(string inFile)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeReadAllLines failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static string SafeReadAllText(string inFile)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeReadAllText failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static bool SafeClearDir(string folderPath, string[] excludeName = null)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeClearDir failed! path = {0} with err = {1}", folderPath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeDeleteDir(string folderPath, string[] excludeName = null)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeDeleteDir failed! path = {0} with err: {1}", folderPath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeDeleteFile(string filePath)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeDeleteFile failed! path = {0} with err: {1}", filePath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeRenameFile(string sourceFileName, string destFileName)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeRenameFile failed! path = {0} with err: {1}", sourceFileName,
                    ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeCopyFile(string fromFile, string toFile)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeCopyFile failed! formFile = {0}, toFile = {1}, with err = {2}",
        ...
        public static bool SafeCopyDirectory(string sourceDirName, string destDirName, bool copySubDirs, string[] excludeName = null)
        {
            ...
            {
                Debugger.LogError(string.Format("SafeCopyDirectory failed! sourceDirName = {0}, destDirName = {1}, with err = {2}",
